# Generated by Django 3.1.2 on 2020-12-19 07:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(upload_to='profile_pics/', validators=[django_clamd.validators.validate_file_infection])),
                ...
                ('proof_of_residence', models.FileField(upload_to='residence_proof/', validators=[django_clamd.validators.validate_file_infection])),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Consumer', 'Consumer'), ('Producer', 'Producer')], max_length=10, null=True)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.Permission', verbose_name='user permissions')),
                ('user_profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='base.profile')),
            ],
            options={
                'verbose_name': 'user',
